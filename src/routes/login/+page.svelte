...
<svelte:head>
    <title>Login to Resin</title>
</svelte:head>

<main
    class="flex-grow flex items-center justify-center px-6 py-20 relative z-10"
>
    <div class="max-w-md w-full">
        ...
        >
            <div class="space-y-4">
                ...
                <p class="text-resin-earth font-light text-balance">
            ...
            <div class="space-y-6">
                ...
                <form method="POST" action="?/signInWithApple">
                    ...
                    >
                        <svg class="w-6 h-6" viewBox="0 0 24 24" fill="currentColor">
                            <path
                                d="M17.05 13.5c-.91 0-1.64.75-1.64 1.74s.73 1.74 1.64 1.74 1.64-.75 1.64-1.74-.73-1.74-1.64-1.74zM17.05 16.7c-.55 0-1-.45-1-1s.45-1 1-1 1 .45 1 1-.45 1-1 1zm3.05-7.2c.91 0 1.64-.75 1.64-1.74s-.73-1.74-1.64-1.74-1.64.75-1.64 1.74.73 1.74 1.64 1.74zm0-2.48c.55 0 1 .45 1 1s-.45 1-1 1-1-.45-1-1 .45-1 1-1zM12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8z"
                            />
                        </svg>
                        Continue with Apple
                    </button>
                ...
                <div
                    class="px-4 py-3 bg-resin-amber/5 border border-resin-amber/20 rounded-xl"
                >
                    <p
                        class="text-[10px] text-resin-amber font-bold uppercase tracking-widest mb-1"
                    >
                        Important
                    </p>
                    <p class="text-xs text-resin-earth/80">
                        Resin requires Google Calendar access to automatically
                        schedule your deep work sessions.
                    </p>
                </div>

                <div
                    class="px-4 py-4 bg-resin-forest/5 border border-resin-forest/10 rounded-xl space-y-2 text-left"
                >
            ...
            {#if form?.error}
                <p class="text-sm text-red-500 font-medium">{form.error}</p>
            {/if}

            <div class="pt-4">
                <a
                    href="/"
                    class="text-sm text-resin-earth/60 hover:text-resin-forest transition-colors underline underline-offset-4 decoration-resin-earth/20"
                >
                    Back to home
                </a>
            </div>
